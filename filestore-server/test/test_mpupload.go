...
func main() {
	username := "peilei"
	token := "03af1c07d408dd90a32c81b7e607e8a062da9e59"
	filehash := "d9af1647ffd28e38b500d3f944eadb418e22e138"
	...
	// 3. 请求分块上传接口
	filename := "/Users/peilei/Downloads/裴雷-中国药科大学-深度学习社区发现课题实验.rar"
	...
	resp, err = http.PostForm(
		...
		url.Values{
			...
			"filehash": {filehash},
			"filesize": {"41804006"},
			"filename": {"裴雷-中国药科大学-深度学习社区发现课题实验.rar"},
			"uploadid": {uploadID},
		})
